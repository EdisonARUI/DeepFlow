...
export function PositionProtocolBanner({
  ...
  return (
    <div className="flex h-9 items-center justify-between bg-bg-secondary px-4">
      <Label className="text-[11px] tracking-[1.1px] text-text-muted uppercase">{label}</Label>
