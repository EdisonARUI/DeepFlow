...
export const MOCK_LIQUIDITY_RAW: LiquidityPositionRaw[] = [
  ...
  {
    protocol: "suilend",
    protocolLabel: "[SUILEND]",
    protocolColor: "#4ADE80",
    asset: "USDC",
    coinType: MAINNET_USDC,
    supplyApyBps: 780,
    tvlUsd: 6_400_000,
    suppliedBalance: BigInt("8200000000"),
    walletCoinBalance: BigInt("4100000000"),
    decimals: 6,
  },
  {
    protocol: "suilend",
    ...
    supplyApyBps: 620,
    tvlUsd: 3_900_000,
    suppliedBalance: BigInt("6100000000000"),
    walletCoinBalance: BigInt("1500000000000"),
    decimals: 9,
  },
];
